        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li <?php if(@$_GET['q']==4) echo'class="active"';?>> <a href="dashboard.php?q=4">Add Quiz</a></li>
                    <li <?php if(@$_GET['q']==5) echo'class="active"'; ?>><a href="dashboard.php?q=5">Remove Quiz</a></li>
                </ul>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                if(@$_GET['q']== 2) 
                {
                    ...
                    <tr style="color:red"><td><center><b>Rank</b></center></td><td><center><b>email</b></center></td><td><center><b>Score</b></center></td></tr>';
                    $c=0;
                ...
                <!-- Quiz details like quiz name, no of questions,marks on right ans, marks for wrong ans -->
                <?php
                    if(@$_GET['q']==4 ) 
                    {
                ...
                <!-- enter questions details like,question and options for the questions -->
                <?php
                    if(@$_GET['q']==4  ) 
                    {
                        echo ' 
